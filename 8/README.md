...
|---------------------|----------|----------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------|
| **title**           | Text     | Yes      | Descriptive name of the Asset                                                                                                                                                                            | [title](https://www.w3.org/TR/vocab-dcat/#Property:distribution_title)              |
| **description**     | Text     | No       | Details of what the resource is. For a data set explain what the data represents and what it can be used for                                                                                             | [description](https://www.w3.org/TR/vocab-dcat/#Property:distribution_description)  |
| **releaseDate**     | DateTime | Yes      | The date on which  was created or was added                                                                                                                                                              | [releaseDate](https://www.w3.org/TR/vocab-dcat/#Property:distribution_release_date) |
| **byteSize**        | Text     | Yes      | Size of the asset (e.g. 18mb). In the absence of a unit (mb, kb etc.), KB will be assumed                                                                                                                | [link](https://www.w3.org/TR/vocab-dcat/#Property:distribution_size)                |
| **publisher**       | Text     | Yes      | Name of the entity generating this data (e.g. Tfl, Disney Corp, etc.)                                                                                                                                    | [publisher](https://www.w3.org/TR/vocab-dcat/#Property:catalog_publisher)           |
| **license**         | Text     | Yes      | Short name referencing to the license of the asset (e.g. Public Domain, CC-0, CC-BY, No License Specified, etc. ). If it's not specified, the following value will be added: "No License Specifiedified" | [license](https://www.w3.org/TR/vocab-dcat/#Property:distribution_license)          |
| **copyrightHolder** | Text     | No       | The party holding the legal copyright. Empty by default                                                                                                                                                  |                                                                                     |
| **rights**          | Text     | No       | Information about rights held in and over the distribution                                                                                                                                               | [rights](https://www.w3.org/TR/vocab-dcat/#Property:distribution_rights)            |
| **encoding**        | Text     | No       | File encoding (e.g. UTF-8)                                                                                                                                                                               |                                                                                     |
| **mediaType**       | Text     | Yes      | File format if applicable                                                                                                                                                                                | [mediaType](https://www.w3.org/TR/vocab-dcat/#Property:distribution_media_type)     |
...
| **language**        | Text     | No       | The language of the content or performance or used in an action. Please use one of the language codes from the [IETF BCP 47 standard](https://tools.ietf.org/html/bcp47)                                 | [language](https://www.w3.org/TR/vocab-dcat/#Property:dataset_language)             |
| **keyword**         | Text     | No       | Keywords or tags used to describe this content. Multiple entries in a keywords list are typically delimited by commas. Empty by default                                                                  | [keyword](https://www.w3.org/TR/vocab-dcat/#Property:dataset_keyword)               |
...
{
    "base": {
        "title": "UK Weather information 2011",
        "description": "Weather information of UK including temperature and humidity",
        "byteSize": "3.1gb",
        "releaseDate": "2012-02-01T10:55:11+00:00",
        ...
        "language": "en",
        "keyword": "weather, uk, 2011, temperature, humidity",
        "price": 10

...
1. The PROVIDER grants the execution permissions for the computation on-chain calling the `ComputeCondition.fullfil` method  

1. The CONSUMER gets the `ComputeCondition.Fullfilled` event. When he/she receives the event, 

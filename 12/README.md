...
In the context of Ocean, data assets (such as data sets or trained models) could be

* published by a person or organization
* comprised of information about a person or set of persons (e.g. a dataset of medical study with data on subjects)
* revised or updated by a different person or organization
* merged by joining one or more datasets 
* generated by a process that takes one or more datasets as inputs (e.g. training a model on 2 datasets).

Ocean provenance records information about the actors (e.g. people), activities (e.g. data cleaning, model training), entities (datasets, algorithms) and the interactions between them. 

A database of provenance metadata can help answer questions such as:

* who was involved in creating the dataset
* when did this dataset last change
* What were the inputs to the process that generated this dataset.
* Which versions of a dataset were used to train a specific model version

...
Definition: **Public Contracts** _noun_ - All public APIs and protocols. In other words, read the OEPs (and the things they reference) and you'll have a good start.
